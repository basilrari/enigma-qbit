...
JOBS = [
    ("d1_s2_adeddcf3", 128, 200000),   # 2nd control (48q, solved instance)
    ("d2_s2_1efabaf4", 128, 200000),
    ("d3_s2_c09ba537", 128, 200000),
]
...
sf = c.open_sftp()
with sf.open(f"{VER}/_launch_sampling3.sh", "w") as f:
    f.write("\n".join(sh) + "\n")
sf.close()
i, o, e = c.exec_command(f"bash {VER}/_launch_sampling3.sh", timeout=60)
